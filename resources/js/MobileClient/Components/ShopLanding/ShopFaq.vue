            ...
            faqItems: [
                {
                    ...
                    answer: 'Среднее время доставки — 40-60 минут в зависимости от вашего района и загрузки кухни. В часы пик (12:00-14:00, 18:00-20:00) время может увеличиться на 10-15 минут. Вы можете отслеживать статус заказа в реальном времени в приложении.'
                },
                {
                    icon: 'fa-solid fa-ruble-sign',
                    question: 'Какая минимальная сумма заказа?',
                    answer: 'Минимальная сумма заказа — 500 рублей для доставки в центр и 1000 рублей для отдалённых районов. Для самовывоза минимальной суммы нет. При заказе от 2000 рублей доставка бесплатная в любую зону.'
                },
                {
                    icon: 'fa-solid fa-credit-card',
                    question: 'Какие способы оплаты доступны?',
                    answer: 'Мы принимаем банковские карты (Visa, MasterCard, МИР), оплату через СБП (Систему Быстрых Платежей), наличные курьеру, Apple Pay и Google Pay. Для юридических лиц доступна оплата по счёту.'
                },
                {
                    icon: 'fa-solid fa-coins',
                    question: 'Как работают бонусы и кэшбэк?',
                    answer: 'С каждого заказа вам начисляется от 3% до 10% бонусами в зависимости от вашего уровня в программе лояльности. 1 бонус = 1 рубль. Бонусами можно оплатить до 50% следующего заказа. Срок действия бонусов — 12 месяцев с момента начисления.'
                },
                {
                    icon: 'fa-solid fa-rotate-left',
                    question: 'Можно ли вернуть или обменять заказ?',
                    answer: 'Если качество блюда вас не устроило, мы вернём деньги или заменим заказ бесплатно. Свяжитесь с поддержкой в течение 30 минут после получения заказа. Для возврата необходимо предоставить фото блюда.'
                },
                {
                    icon: 'fa-solid fa-utensils',
                    question: 'Можно ли внести изменения в заказ после оформления?',
                    answer: 'Изменить заказ можно в течение 5 минут после оформления, пока он не передан на кухню. Свяжитесь с поддержкой по телефону или в чате — мы оперативно внесём изменения.'
                },
                {
                    icon: 'fa-solid fa-gift',
                    question: 'Есть ли акции и промокоды?',
                    answer: 'Да! Мы регулярно проводим акции и раздаём промокоды в нашем Telegram-канале и через push-уведомления в приложении. Подпишитесь, чтобы не пропустить выгодные предложения. Также действует реферальная программа: приводите друзей и получайте бонусы.'
                }
            ]
        };
    },
