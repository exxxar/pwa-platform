                ...
                <div v-for="item in achievements" :key="item.id" class="achievement-card"
                    ...
                    <div class="card-header">
                        <div class="achievement-icon"
                             :style="{ background: item.is_active ? 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)' : '#e5e7eb' }">
                            ...
                            <div class="form-grid">
                                <div class="form-field full-width">
                                    ...
                                    <input type="text" v-model="form.title" required
                                           placeholder="Например: Первый заказ">
                                </div>
                                <div class="form-field full-width">
                                    <label>Описание</label>
                                    <textarea v-model="form.description" rows="2"
                                              placeholder="Сделайте свой первый заказ в нашем магазине"></textarea>
                                </div>
                                ...
                                <div class="form-field">
                                    ...
                                    <select v-model="form.condition_type" required>
                                        <option v-for="(label, key) in conditionTypes" :key="key" :value="key">{{
                                                label
                                            }}
                                        </option>
                                    </select>
                                ...
                                <div class="form-field">
                                    ...
                                    <input type="number" v-model="form.condition_value" required min="1"
                                ...
                                <div class="form-field">
                                    ...
                                    <select v-model="form.reward_type" required>
                                        <option v-for="(label, key) in rewardTypes" :key="key" :value="key">{{
                                                label
                                            }}
                                        </option>
                                    </select>
                                ...
                                <div class="form-field">
                                    ...
                                    <input type="number" v-model="form.reward_value" required min="0"
