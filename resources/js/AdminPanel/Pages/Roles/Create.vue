<template>
    <div class="role-create-page">
        <div class="page-header">
            <div>
                <h1 class="page-title">Создать роль</h1>
                <p class="page-subtitle">Настройте новую роль и назначьте разрешения</p>
            </div>
        </div>
...
const handleSubmit = async () => {
    ...
    try {
        ...
        notifications.success('Роль успешно создана')
        ...
        if (error.response?.status === 422) {
            ...
            notifications.error('Ошибка при создании роли')
        }
    } finally {
        loading.value = false
    }
